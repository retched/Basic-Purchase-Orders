...
class purchaseorders
{
    ...
    function __construct()
    {
        ...
        if (!defined('MODULE_PAYMENT_PURCHASEORDER_PAYTO')) {
            $db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Purchase Order Payee', 'MODULE_PAYMENT_PURCHASEORDER_PAYTO', '" . STORE_OWNER ."', 'Who should payments be made payable to?', '6', '2', now());");
